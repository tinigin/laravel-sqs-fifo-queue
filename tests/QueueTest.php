...
use Tinigin\LaravelSqsFifoQueue\Tests\Fakes\Mail;
use Tinigin\LaravelSqsFifoQueue\Tests\Fakes\StandardJob;
use Tinigin\LaravelSqsFifoQueue\Tests\Fakes\Notification;
...
class QueueTest extends TestCase
{
    ...
    protected function bind_custom_deduplicator()
    {
        $this->app->bind('queue.sqs-fifo.deduplicator.custom', function () {
            return new \Tinigin\LaravelSqsFifoQueue\Queue\Deduplicators\Callback(function ($payload, $queue) {
                return 'custom';
            });
        });
    }
